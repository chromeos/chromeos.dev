...
hero:
  youtube: eJ5FpTltXZU
  alt: We recently shared the latest Chrome OS updates at Google I/O 2023.
theme:
  eyebrow: Google I/O
  icon: ix://posts/io-2022/Chrome_IOBlogpost_Eyebrow_1.svg
  theme: io-2023
  background:
    top: /images/23Chrome_Blog_IO23_Dektop_BG+Pattern.svg
    bottom: /images/23Chrome_Blog_IO23_Mobile_BG+Pattern.svg
featured:
  images:
...
![Three devices from left to right: the HP Dragonfly Pro Chromebook, HP Elite Dragonfly Chromebook, and Framework Laptop Chromebook Edition](/images/23Chrome_Blog_IO23_Devices.png)

Three devices from left to right: the HP Dragonfly Pro Chromebook, HP Elite Dragonfly Chromebook, and Framework Laptop Chromebook Edition

![PC and console games from Xbox Cloud Gaming, NVIDIA GeForce NOW, Boosteroid, and Amazon Luna on a Chromebook]()

Whichever Chromebook you choose will work seamlessly with your Android phone. For instance, you can control phone features directly from your laptop in **Phone Hub **and easily connect to your mobile hotspot with **Instant Tethering**.
...
%[(22%, Growth in active enterprise ChromeOS devices YOY), (13K, Businesses rely on ChromeOS), (245%, Average ROI with ChromeOS)]

To help businesses make strategic investments, we expanded [Chrome Enterprise Recommended](https://chromeenterprise.google/recommended/?utm_source=adwords&utm_medium=cpc&utm_campaign=2023-H1-chromebrowser-paidmed-paiddisplay-other-chromebrowserent&utm_term=downloadnow-chrome-browser-enterprise-download&utm_content=GCFW) — our suite of industry solutions. One of our latest additions is a solution track for clinicians we launched with leading partners such as Imprivata OneSign, Practice Fusion, and Athenahealth. Businesses across verticals are also using our digital kiosk and signage solutions to set up menu boards, check-in kiosks, and more.
...
We know a durable device fleet makes a big difference. That’s why we made refreshing old devices easier by widening ChromeOS Flex availability. Take Mercado Libre, for example. The Latin American e-commerce chain used ChromeOS Flex to update its aging PCs across contact centers in 18 countries, increasing contact center productivity by 15% and saving 150 hours of device boot-up time per contact center shift.

All it takes to deploy ChromeOS Flex is a USB drive and a simple three-step installation process. We’ve already seen a 46% growth in activations YOY, which means more businesses than ever are looking for enterprise apps on ChromeOS.[^5] If you’ve got an old laptop lying around, we’d love for you to [try out ChromeOS Flex](https://chromeenterprise.google/os/chromeosflex/) as well. And if you’re curious about what else our enterprise team has been up to, head over to their roundup.
...
![A chart of app platforms for building Chromebook-optimized apps. Devs can use the web and Android to build apps and games optimized for Chromebook users.](/images/23Chrome_Blog_IO23_App+Platform.png)
...
- [LumaFusion](https://play.google.com/store/apps/details?id=com.luma_touch.lumafusion): Tailored its award-winning multitrack video editing app for ChromeOS and Android, after which more than 50% of new Android users downloading the app did so on larger screens
...
![The early access version Minecraft: Bedrock Edition shown on a Chromebook, with the Minecraft logo to the bottom left.](/images/23Chrome_Blog_IO23_Mincraft.png)
...
So, continue doing what you do best. We’ll stay in your corner, as always. We’re [on Discord](https://discord.com/channels/1009525727504384150/1065730991026602056) ready to chat, so swing by with all your ChromeOS questions. New dev tools and guidance for creating inspiring go-to apps for a global community are in the works too. Stay in the loop by [signing up for our newsletter](/{{locale.code}}/subscribe) — and in the meantime, get more tips and inspiration from ChromeOS.dev and our [Google I/O 2023 talks](https://www.youtube.com/playlist?list=PLNYkxOF6rcICFB5ejR8ezf2pglcfA6H).
