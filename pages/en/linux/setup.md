...
#1[Enable Linux from Chrome settings.](/images/linux/getting-started/enable-linux.png)
...
#2[Pinning the Terminal app to the shelf.](/images/linux/getting-started/pin-to-shelf.png)
...
![Drag and drop files or directories to "Linux files".](/images/linux/copy-to-linux.png)
...
![Right click on a directory to select "Share with Linux" option.](/images/linux/share-with-linux.png)
...
#3[Install prompt for VS Code.](/images/linux/getting-started/deb-install.jpg)
...
#4[Software running on Chrome OS.](/images/linux/getting-started/software.png)

#5[Package running on Chrome OS.](/images/linux/getting-started/package.png)
...
#6[Shutting down the Linux container.](/images/linux/getting-started/shut-down.png)
