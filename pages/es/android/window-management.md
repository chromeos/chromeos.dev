...
- Reconstruya el estado previo usando el componente de arquitectura [ViewModel](https://developer.android.com/topic/libraries/architecture/viewmodel?hl=es) y `onSaveInstanceState` para que las transciciones sean tan simples como sea posible. Esto aplica para cuando solicitar reiniciar y es la mejor opción.
...
Hay más información sobre el manejo de cambios de configuración, como el cambio de tamaño en los [documentos para manejo de cambios de configuración](https://developer.android.com/guide/topics/resources/runtime-changes?hl=es)
